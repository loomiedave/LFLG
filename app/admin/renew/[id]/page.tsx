          ...
          <div className="flex items-center gap-4 mb-6">
            ...
            <div>
              ...
              <p className="text-gray-600 dark:text-gray-400">
                {license.licenseType === 'PLAYER' ? 'Joueur' : 'Entraîneur'} - {license.clubName}
              </p>
              <span className={`inline-flex px-2 py-1 text-xs font-semibold rounded-full mt-2 ${getStatusColor(license.status)}`}>
            ...
            {license.renewals.length > 0 ? (
              <div className="space-y-3">
                {license.renewals.map((renewal) => (
                  <div key={renewal.id} className="p-3 bg-gray-50 dark:bg-gray-800 rounded-lg">
