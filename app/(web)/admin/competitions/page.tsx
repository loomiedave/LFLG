        ...
        <div className="bg-white shadow rounded-lg">
          <table className="min-w-full">
            <thead className="bg-gray-50">
              <tr>
                <th className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase">Competition Title</th>
            ...
            <tbody className="divide-y divide-gray-200">
              {competitions.map((comp) => (
                <tr key={comp.id} className="hover:bg-gray-50">
                  ...
                  <td className="px-6 py-4 text-sm text-gray-900">{comp.clubName}</td>
                  <td className="px-6 py-4 text-sm text-gray-900">{comp.districtName}</td>
                  <td className="px-6 py-4 text-sm text-gray-900">
                    {new Date(comp.dateRegistered).toLocaleDateString()}
                  </td>
                  <td className="px-6 py-4 text-sm text-gray-900">${comp.feesPaid}</td>
                </tr>
              ))}
            </tbody>
          </table>
